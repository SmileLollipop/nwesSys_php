...
<head>
    ...
    <title>新闻首页</title>
    <link rel="stylesheet" media="(max-width:800px)" href="/newsSys/Public/Common/css/bootstrap.min.css"/>
    <link rel="stylesheet" media="(max-width:800px)" href="/newsSys/Public/Home/css/style.css"/>
    <script src="/newsSys/Public/Common/js/jquery.min.js"></script>
    <script src="/newsSys/Public/Common/js/bootstrap.min.js"></script>
</head>
<body>
<header>
    <div class="toolbar">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-4 col-sm-2 imgBox">
                        <?php if(empty($v["img"])): ?><img src="/newsSys/Public/Common/img/preview.jpg">
                            <?php else: ?>
                            <img src="/newsSys/Public/Uploads/small/<?php echo ($v["img"]); ?>"><?php endif; ?>
                    </div>
