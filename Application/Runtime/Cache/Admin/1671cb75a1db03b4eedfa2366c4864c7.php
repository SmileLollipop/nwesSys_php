...
<div class="main">
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-xs-10">
				<div class="content">
				<div class="item"><div class="item-title">新闻修改</div>

<div class="top-button">
	<a href="<?php echo U('List/index');?>" class="btn btn-warning">返回新闻列表</a>
</div>

<?php if(isset($success)): ?><div class="message">~ ~ ~  更新成功!  ~ ~ ~  </div><?php endif; ?>
	...
	<div class="panel-body">
		<form class="form-horizontal" enctype="multipart/form-data" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<input type="text" name="title" class="form-control" id="newsTitle" value="<?php echo ($list["title"]); ?>">
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" name="lable" class="form-control" id="newsLable" value="<?php echo ($list["lable"]); ?>">
				</div>
				<?php if(isset($errors['lable'])): ?><span class="tip col-sm-4"><?php echo ($errors["lable"]); ?></span><?php endif; ?>
			</div>
			<div class="form-group">
				<label for="newsImage" class="col-sm-2 control-label">修改图片：</label>
				<div class="col-sm-5">
			...
			<div class="form-group">
				<label for="newsImage" class="col-sm-2 control-label">当前图片：</label>
				<div class="col-sm-3">
					<?php if(empty($list["img"])): ?><img src="/newsSys_php/Public/Common/img/preview.jpg" class="img-thumbnail">
						<?php else: ?>
						<img src="/newsSys_php/Public/Uploads/big/<?php echo ($list["img"]); ?>" class="img-thumbnail"><?php endif; ?>
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button type="submit" class="btn btn-warning">修改新闻</button>
				</div>
			</div>
		</form>
	</div>
...
<script>
	$("#newsCategory").val(<?php echo ($list[cid]); ?>);
</script></div>
				</div>
			</div>
		</div>
